                ...
                pipelineTriggers {
                    triggers {
                        genericTrigger {
                            ...
                            logger.info("==============================+++")
                            logger.info(webHookArgs.prFilterText)
                            logger.info(this.repoUrl)
                            logger.info(resolveUrl(this.repoUrl))
                            logger.info(String.format(webHookArgs.prFilterText, resolveUrl(this.repoUrl)))
                            logger.info("==============================+++")
